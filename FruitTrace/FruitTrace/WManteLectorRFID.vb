...
Public Class WManteLectorRFID
    Private fAppClosed As Boolean 'ÔÚ²âÊÔÄ£Ê½ÏÂÏìÓ¦¹Ø±ÕÓ¦ÓÃ³ÌÐò
    Private fComAdr As Byte = &HFF 'µ±Ç°²Ù×÷µÄComAdr
    ...
    Private fCmdRet As Integer = 30 'ËùÓÐÖ´ÐÐÖ¸ÁîµÄ·µ»ØÖµ
    Private fOpenComIndex As Integer '´ò¿ªµÄ´®¿ÚË÷ÒýºÅ
    ...
    Private fInventory_EPC_List As String '´æÖüÑ¯²éÁÐ±í£¨Èç¹û¶ÁÈ¡µÄÊý¾ÝÃ»ÓÐ±ä»¯£¬Ôò²»½øÐÐË¢ÐÂ£©
    ...
    Private Sub OpenPort_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles OpenPort.Click
        ...
        Try
            If (ComboBox_COM.SelectedIndex = 0) Then
                'MsgBox(ComboBox_baud2.SelectedIndex)
    ...
    Private Sub ClosePort_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles ClosePort.Click
        ...
        Try
            If (ComboBox_AlreadyOpenCOM.SelectedIndex < 0) Then
                MessageBox.Show("Please Choose COM Port to close", "ÐÅÏ¢ÌáÊ¾")
            Else
                temp = ComboBox_AlreadyOpenCOM.SelectedItem.ToString()
                port = Convert.ToInt32(temp.Substring(3, temp.Length - 3))
                ...
                If (fCmdRet = 0) Then
                    ...
                    If (ComboBox_AlreadyOpenCOM.Items.Count <> 0) Then
                        ...
                        fOpenComIndex = frmcomportindex
                        RefreshStatus()
                        Button3_Click(sender, e) '×Ô¶¯Ö´ÐÐ¶ÁÈ¡Ð´¿¨Æ÷ÐÅÏ¢
                    End If
                Else
